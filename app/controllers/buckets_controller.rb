class BucketsController < ApplicationController
  ...
  def add_collaborators
    ...
    bucket.add_collaborators_from_contacts_with_calling_code(params[:contacts], User.find_by_id(params[:auth][:uid]).calling_code) if bucket && bucket.belongs_to_user?(user)
