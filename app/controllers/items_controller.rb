class ItemsController < ApplicationController
  ...
  def changes
    ...
    items = params.has_key?(:updated_at_timestamp) && params[:updated_at_timestamp].length > 0 ? user.items.not_deleted.above(params[:updated_at_timestamp]).by_date.limit(512) : user.items.not_deleted.by_date.limit(512)
